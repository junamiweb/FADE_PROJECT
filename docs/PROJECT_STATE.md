...
| **2** | יצירת repo Private ב-github.com/new (ללא README/gitignore) | ⏸ **ממתין ל-URL מהמשתמש** |
| **3** | `git init` + push ל-`main` | ⏸ ממתין לשלב 2 |
...
**cron:** לא פעיל עד ששלב 6 עובר בהצלחה בהרצה ידנית.
